    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            File file = ("/").equals(requestLineData[1]) ?
                    new File("E:\\大三\\resource\\index.html") :
                    new File("E:\\大三\\resource" + requestLineData[1]);
            ...
            if (file.exists()) {
                ...
                bis = new BufferedInputStream(new FileInputStream(new File("E:\\大三\\resource\\error.html")));
